...
public class AgentTest extends UntypedActor {
    ...
    public static ConcurrentLinkedQueue<Future<Integer>> queue = new ConcurrentLinkedQueue<Future<Integer>>();
    @Override
    ...
    public static void main(String [] args) throws InterruptedException, TimeoutException {
        final ActorSystem system = ActorSystem.create("inbox", ConfigFactory.load("akka.conf"));
